...
From Lustre wkik: when using the Lustre ldiskfs OSD only, it will be necessary to patch the kernel 
before building Lustre.  The Lustre ZFS OSD and the Lustre client code do not require patches to
the kernel.
